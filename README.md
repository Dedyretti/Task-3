...
- **Название основного репозитория:** `____________`(Любое к примеру team-metrics-system ) 
...
**Шаг 1.2: Создание структуры файлов через веб-интерфейс**
...
**Шаг 2.3: Настройка связи с основным репозиторием**
```bash
